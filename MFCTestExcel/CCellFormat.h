...
public:
	...
	void putref_Borders(LPDISPATCH newValue)
	{
		...
		InvokeHelper(0x1b3, DISPATCH_PROPERTYPUTREF, VT_EMPTY, nullptr, parms, newValue);
	}
	LPDISPATCH get_Font()
	{
		LPDISPATCH result;
	...
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0x92, DISPATCH_PROPERTYPUTREF, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0x81, DISPATCH_PROPERTYPUTREF, VT_EMPTY, nullptr, parms, newValue);
	}
