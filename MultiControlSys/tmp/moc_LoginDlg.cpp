...
QT_MOC_LITERAL(1, 9, 17), // "sig_pictureChange"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16) // "on_btnok_clicked"

    },
    "LoginDlg\0sig_pictureChange\0\0"
    "on_btnok_clicked"
};
...
void LoginDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_pictureChange(); break;
        ...
        {
            using _t = void (LoginDlg::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginDlg::sig_pictureChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDlg::sig_pictureChange()
{
