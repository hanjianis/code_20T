...
// Area ID
const unsigned char S7AreaPE   =	0x81;
const unsigned char S7AreaPA   =	0x82;
const unsigned char S7AreaMK   =	0x83;
const unsigned char S7AreaDB   =	0x84;
const unsigned char S7AreaCT   =	0x1C;
const unsigned char S7AreaTM   =	0x1D;
...
// Block type
const unsigned char Block_OB   = 0x38;
const unsigned char Block_DB   = 0x41;
const unsigned char Block_SDB  = 0x42;
const unsigned char Block_FC   = 0x43;
const unsigned char Block_SFC  = 0x44;
const unsigned char Block_FB   = 0x45;
const unsigned char Block_SFB  = 0x46;

// Sub Block Type
const unsigned char SubBlk_OB  = 0x08;
const unsigned char SubBlk_DB  = 0x0A;
const unsigned char SubBlk_SDB = 0x0B;
const unsigned char SubBlk_FC  = 0x0C;
const unsigned char SubBlk_SFC = 0x0D;
const unsigned char SubBlk_FB  = 0x0E;
const unsigned char SubBlk_SFB = 0x0F;

// Block languages
const unsigned char BlockLangAWL       = 0x01;
const unsigned char BlockLangKOP       = 0x02;
const unsigned char BlockLangFUP       = 0x03;
const unsigned char BlockLangSCL       = 0x04;
const unsigned char BlockLangDB        = 0x05;
const unsigned char BlockLangGRAPH     = 0x06;
